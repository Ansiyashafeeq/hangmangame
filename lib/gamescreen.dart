...
import 'package:hangmangame/utilse.dart';
import 'package:audioplayers/audioplayers.dart';
import 'dart:math';

class Hman extends StatefulWidget {
  const Hman({Key? key}) : super(key: key);

  @override
  State<Hman> createState() => _HmanState();
}

class _HmanState extends State<Hman> {
  ...
  checkletter(String alphabet){
    if(word.contains(alphabet)){
      ...
      playsound("sounds_correct.mp3");
    }else if(ststus != 6){
      setState(() {
        ststus +=1;
        points -= 5;
      });
      playsound("sounds_wrong.mp3");
    }else{
      opendailog("you lost !");
      playsound("sounds_lost.mp3");
    }
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(title:Text('HANGMAN',style: retrostyl(30,Colors.white,FontWeight.w700),)
              ...
              GridView.count(crossAxisCount: 7,
                ...
                letters.map(
                      ...
                      return InkWell(
                        ...
                        child: Center(
                          child: Text(
                            alphabet,style: retrostyl(25,Colors.white,FontWeight.bold
                          ),
                          ),
                        ),
                      );
